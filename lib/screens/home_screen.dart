import 'package:budget_tracker/data/data.dart';
...
import 'package:budget_tracker/widgets/bar_chart.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  buildCategory(BudgetCategory category, double totalAmountSpent) {
        ...
        slivers: [
          ...
          SliverList(
            ...
            if (index == 0) {
              ...
              final BudgetCategory category = categories[index - 1];
